    ...
    return (
        <>
            ...
            <nav className="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large"
                ...
                <a className="w3-bar-item w3-button w3-large w3-padding-16"> Close ×</a>
            ...
            <div className="w3-container" style={{ padding: "128px 16px" }} id="work">
                ...
                {/* <div className="w3-row-padding" style={{ marginTop: "64px" }}>
                    ...
                    <div className="w3-col l3 m6">
                        <img src="/w3images/tech_drone.jpg" style={{ width: "100%" }} className="w3-hover-opacity" alt="A drone" />
                    </div>
                    <div className="w3-col l3 m6">
                ...
                <div className="w3-row-padding w3-section">
                    ...
                    <div className="w3-col l3 m6">
                        <img src="/w3images/tech_camera.jpg" style={{ width: "100%" }} className="w3-hover-opacity" alt="A camera" />
                    </div>
                    <div className="w3-col l3 m6">
                        <img src="/w3images/tech_typewriter.jpg" style={{ width: "100%" }} className="w3-hover-opacity" alt="A typewriter" />
                    </div>
                    <div className="w3-col l3 m6">
